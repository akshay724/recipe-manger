@echo off
title Push Person 1 RannaGhor to GitHub
color 0A
cls
echo ======================================================================
echo       RannaGhor Project - GitHub Push Helper (Person 1)
echo       Module: Recipe Discovery, Regional Bengali Localization & Interactive Cooking Engine
echo ======================================================================
echo.
...
if %ERRORLEVEL% equ 0 (
    echo.
    echo ======================================================================
    echo  SUCCESS! Person 1's repository has been pushed to GitHub!
    echo  URL: %REPO_URL%
    echo ======================================================================
) else (
    echo.
