@echo off
title Push Person 4 RannaGhor to GitHub
color 0A
cls
echo ======================================================================
echo       RannaGhor Project - GitHub Push Helper (Person 4)
echo       Module: Google Account Authentication, Security Alerts & Email Notification Hub
echo ======================================================================
echo.
...
if %ERRORLEVEL% equ 0 (
    echo.
    echo ======================================================================
    echo  SUCCESS! Person 4's repository has been pushed to GitHub!
    echo  URL: %REPO_URL%
    echo ======================================================================
) else (
    echo.
